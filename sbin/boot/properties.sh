...
echo "CF-Root 5.5" >> /customkernel/property/customkernel.namedisplay 
echo 123 >> /customkernel/property/customkernel.version.number 
echo 5.5 >> /customkernel/property/customkernel.version.name 
